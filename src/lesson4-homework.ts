...
function exercise17() {
  ...
  class Student {
    ...
    constructor(name: string, age: number, studentId: string | number) {
      this.name = name;
      this.age = age;
...
function exercise19() {
  ...
  function formatCommandLine(command: string | string[]) {
    ...
    } else console.log("command must be string or string[]");
  }
...
function exercise21() {
  ...
  const widgetWithSize: TWidget & TWidgetWithSizeAndColor = {
    name: "widget",
    width: 10,
    height: 20,
    color: "red",
  };
  const desktopWidget: TWidget & TWidgetWithSizeAndColor & TDesktopOSWidget = {
    name: "widget",
    width: 10,
    height: 20,
    color: "red",
  ...
  const mobileWidget: TWidget & TWidgetWithSizeAndColor & TMobileWidget = {
    name: "widget",
    width: 10,
    height: 20,
    color: "red",
