...
function exercise28() {
  ...
  class WidgetWithSize implements IWidgetWithSize, IWidgetPrintable {
    ...
    toString(): void {
      console.log(
        `Widget with size - name: ${this.name}; width: ${this.width}; height: ${this.height}; color: ${this.color}.`
      );
    }
  }
  ...
  class DesktopWidget
    extends WidgetWithSize
    implements IDesktopWidget, IWidgetPrintable
  {
    constructor(
      public name: string,
      public width: number,
    ...
    toString(): void {
      console.log(
        `Desktop widget - name: ${this.name}; width: ${this.width}; height: ${this.height}; color: ${this.color}; os: ${this.os}.`
      );
    }
  }
  ...
  class MobileWidget
    extends WidgetWithSize
    implements IMobileWidget, IWidgetPrintable
  {
    constructor(
      public name: string,
      public width: number,
    ...
    toString(): void {
      console.log(
        `Mobile widget - name: ${this.name}; width: ${this.width}; height: ${this.height}; color: ${this.color}; space: ${this.space}.`
      );
    }
  }
    ...
    implements IDesktopWidget, IMobileWidget, IWidgetPrintable
  {
    ...
    toString(): void {
      console.log(
        `Desktop and mobile widget - name: ${this.name}; width: ${this.width}; height: ${this.height}; color: ${this.color}; os:${this.os}; space: ${this.space}.`
      );
    }
  }
